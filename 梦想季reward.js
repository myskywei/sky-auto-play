...
var turbiControl=1;
var time1=888;//1拍的时间
var time2=444;//2/1拍时间
var time4=222;//4/1拍时间
var time8=111;//8/1拍时间
var time16=55//16/1拍时间

setScreenMetrics(1080, 2340);//默认分辨率，以下按键位置基于此分辨率
var x=[687,923,1200,1486,1764];
var y=[235,508,774];

function ran(){return Math.random()*36-18}//+18~-18随机数
function duration(){return 10*turbiControl+20}//每个音符按压的持续时间，最少20ms，每次增加10ms
